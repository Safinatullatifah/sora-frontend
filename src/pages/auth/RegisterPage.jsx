...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-sora-bg flex items-center justify-center p-4 sm:p-6 font-sans relative overflow-hidden">
      <div className="bg-white max-w-lg w-full p-6 sm:p-10 rounded-[2rem] sm:rounded-[3rem] shadow-2xl shadow-sora-blue/10 border border-gray-100 relative z-10">
        ...
        {!isSuccess ? (
          <div className="animate-in fade-in slide-in-from-bottom-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={isLoading} className="w-full bg-sora-navy text-white py-4 sm:py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-sora-blue transition-all mt-6 shadow-xl shadow-sora-navy/20 disabled:opacity-50">
