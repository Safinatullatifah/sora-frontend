        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-gray-50 text-[10px] font-black text-sora-gray uppercase tracking-widest border-b">
            <tr>
              ...
              <th className="p-6">Tenggat Waktu</th>
              ...
              <tr key={t.id} className={`border-b border-gray-50 transition-all ${t.status === 'Lunas' ? 'bg-gray-50/50 opacity-80 hover:opacity-100' : 'hover:bg-sora-bg/50'}`}>
                ...
                <td className="p-6 text-center">
                  {t.status === 'Belum Bayar' ? (
                    <button onClick={(e) => handlePay(t, e)} className="bg-sora-blue text-white px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-sora-navy transition-all shadow-md shadow-sora-blue/20">Bayar</button>
                  ) : t.status === 'Lunas' ? (
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 p-5 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center hover:border-sora-blue transition-all group">
                ...
                <div className="text-left md:text-right w-full md:w-auto">
                  ...
                  <button onClick={handlePayPaket} className="w-full md:w-auto bg-sora-bg text-sora-blue border border-sora-blue/20 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-sora-blue hover:text-white transition-all">Pilih Paket</button>
                </div>
              </div>
              <div className="border border-gray-200 p-5 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center hover:border-sora-blue transition-all group">
                <div className="mb-3 md:mb-0">
              ...
              <div className="border border-sora-green bg-sora-green/5 p-5 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center relative overflow-hidden">
                ...
                <div className="text-left md:text-right w-full md:w-auto">
                  ...
                  <button onClick={handlePayPaket} className="w-full md:w-auto bg-sora-green text-white px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-green-700 shadow-lg shadow-green-500/20 transition-all">Pilih Paket</button>
                </div>
              </div>
            </div>
          </div>
